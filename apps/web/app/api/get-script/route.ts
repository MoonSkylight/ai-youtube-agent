...
export default function ContentDetailPage({
  ...
  const scriptPreview = useMemo(() => {
    ...
    return script.script_body.trim();
  }, [script]);
  ...
  return (
    <main className="app-shell">
      <div className="topbar">
        <div className="brand">
          <span className="brand-badge">AI YouTube Agent</span>
          <h1 className="page-title">{script.title}</h1>
          <p className="page-subtitle">Generate, review, and publish this script.</p>
        </div>
            ...
            <div className="row-between">
              <div>
                ...
                <p className="card-muted">
                  Review the script before creating a video.
                </p>
              </div>
              <span className="badge badge-neutral">Script Ready</span>
            </div>
        ...
        <div className="card">
          <div className="card-body stack">
            <div>
              ...
              <p className="card-muted">
                Choose a workflow to create or publish content.
              </p>
            </div>
